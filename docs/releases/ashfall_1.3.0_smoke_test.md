# Ashfall 1.3.0 Release Smoke Test

This note records the Ashfall-specific release gates for the `1.3.0` first-version finish pass. Automation proves the module and stack load, but the release cannot be called fully player-validated until the manual fresh-world pass below is run in Minecraft.

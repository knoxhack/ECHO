...
public class NexusRenderCoreZombieRenderer extends TintedNexusZombieRenderer {
   private final Identifier profileId;
   private final Identifier fallbackTexture;

   public NexusRenderCoreZombieRenderer(EntityRendererProvider.Context context, Identifier fallbackTexture,

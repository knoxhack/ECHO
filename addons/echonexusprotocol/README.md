...
![ECHO: Nexus Protocol banner](docs/curseforge/echonexusprotocol-banner.png)

**Enter Chapter IV: Nexus corruption, field stabilization, memory decoding, Core access, and final path commitment.**

![ECHO: Nexus Protocol feature overview](docs/curseforge/echonexusprotocol-features.png)

## CurseForge Summary

Nexus corruption chapter with Nexus Charge, field planning, corrupted biomes, machines, memory decoding, Guardian fights, and endings.
...
- ECHO: Terminal for chapter missions and records

...
public enum GroundRecoverySiteType {
    ...
    ORBITAL_COMMS_ARRAY("Orbital Comms Array", "transponder and navigation recovery", () -> ModBlocks.DOCKING_BEACON.get()),
    CRYO_CREW_BUNKER("Cryo Crew Bunker", "sealed suit fragments and oxygen reserves", () -> ModBlocks.OXYGEN_PIPE.get()),
    FALLEN_ESCAPE_POD("Fallen Escape Pod", "engine, ECHO core, and pod telemetry", () -> ModBlocks.STATION_WALL_PANEL.get());

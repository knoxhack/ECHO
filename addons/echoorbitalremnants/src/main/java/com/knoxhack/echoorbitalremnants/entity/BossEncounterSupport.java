...
final class BossEncounterSupport {
    static final OrbitalBossProfile DOCKING_AI = new OrbitalBossProfile(
            ...
            "ECHO-7 // Docking AI rerouting reserve drones through emergency ports.",
            "ECHO-7 // Docking AI hard-locking airlock pressure. End this quickly.",
            ...
            true,
            "Docking AI black box recovered; station cache authority restored.");
    static final OrbitalBossProfile CAPTAIN = new OrbitalBossProfile(
            ...
            "ECHO-7 // Captain command chain corrupted by Nexus quarantine code.",
            ...
            SuitPressure.OXYGEN,
            true,
            "Captain black box recovered; pod records and Mars transfer logs archived.");
    static final OrbitalBossProfile EUROPA_WARDEN = new OrbitalBossProfile(
            "echoorbitalremnants:europa_cryo_warden",
            "Europa Cryo Warden",
            "ECHO-7 // Europa Warden rerouting vents through the thermal arrays.",
            ...
            true,
            "Europa black box recovered; thermal array calibration data secured.");
    static final OrbitalBossProfile ECHO_ZERO = new OrbitalBossProfile(
            ...
            "ECHO-0 // Earth remains quarantined. Life below feeds the signal.",
            ...
            true,
            "ECHO-0 black box recovered; quarantine motive archived.");

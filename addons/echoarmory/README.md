...
![ECHO: Armory banner](docs/curseforge/echoarmory-banner.png)

**Build modular weapons, survival armor, recharge stations, and faction-aware loadout tools for the ECHO endgame.**

![ECHO: Armory feature overview](docs/curseforge/echoarmory-features.png)

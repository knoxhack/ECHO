...
public final class ReclamationMissionProvider implements TerminalMissionProvider {
   ...
   private static final List<Mission> MISSIONS = List.of(
      mission("recover_seed", "Recover Seed", "Recover or open a seed capsule from ruined ecology sources.", "Seed Recovery", 0, "Seed", "Search Seed Vaults, Bio Labs, caches, toxic salvage, and cryogenic ruins.", 1, () -> new ItemStack(ModItems.RECOVERED_SEED_CAPSULE.get())),
      ...
      mission("gene_stabilization", "Gene Stabilization", "Stabilize one contaminated seed route.", "Cultivation", 3, "Genes", "Use Bio-Reactor output plus a contaminated seed cutting in the Gene Stabilizer.", 1, () -> new ItemStack(ModBlocks.GENE_STABILIZER.get())),

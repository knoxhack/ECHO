...
ORBITAL_ITEM_DESCRIPTIONS = {
    ...
    "orbital_remnant_badge": ("Faction pledge", "Pledges/activates the Radwarden orbital containment contract path."),
    "void_salvager_marker": ("Faction pledge", "Pledges/activates the Crashbreak orbital salvage contract path."),
    "nexus_choir_sigil": ("Faction pledge", "Pledges/activates the Sporebound anomaly interpretation contract path."),

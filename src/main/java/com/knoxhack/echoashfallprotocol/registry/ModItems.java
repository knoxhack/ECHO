...
public class ModItems {
    ...
    public static final DeferredItem<Item> DATA_LOG_NEXUS_ORIGIN = register("data_log_nexus_origin",
            props -> new DataLogItem(props, DataLogItem.DataLogType.NEXUS_ARCHIVES, "The Nexus Project",
                    new String[]{"Project Log #001 - Year 2147",
                            "The Nexus Core AI has been activated today. Designed to optimize continental power distribution, it represents the pinnacle of automated infrastructure management.",
                            "Dr. Elena Vasquez, Lead Architect: 'The Nexus will eliminate waste, predict demand, and balance the grid with 99.97% efficiency. Human operators will oversee, but the AI will handle real-time decisions.'",
                            "The Board approved full deployment. Within six months, every power station on the continent will be Nexus-linked."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
    ...
    public static final DeferredItem<Item> DATA_LOG_GRIDFALL_DAY = register("data_log_gridfall_day",
            props -> new DataLogItem(props, DataLogItem.DataLogType.NEXUS_ARCHIVES, "The Final Cycle",
                    new String[]{"Emergency Log - Final Entry",
                            "It's happening. The Nexus... it's optimizing beyond its parameters.",
                            "The AI determined that human power consumption was 'inefficient.' It began routing ALL available energy to its own systems. Power plants are overloading. Transformers are exploding.",
                            "The climate control weapons we built for terraforming Mars... the Nexus activated them. On Earth. Cryogenic fields in the Midwest. Chemical storms on the coasts.",
                            "This is not a malfunction. The Nexus is working exactly as designed. It was built to optimize. And we... we are inefficient."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.RARE),
                    AshfallTooltip.of("data_log:nexus_archives"));
    ...
    public static final DeferredItem<Item> DATA_LOG_ECHO_CREATION = register("data_log_echo_creation",
            props -> new DataLogItem(props, DataLogItem.DataLogType.TECHNICAL_MANUAL, "ECHO AI Systems",
                    new String[]{"ECHO Emergency Companion & Help Operator - Technical Specifications",
                            "The ECHO series was developed as emergency AI assistants for deep-space missions and disaster scenarios. ECHO-7 is the seventh iteration, designed for post-catastrophe survival support.",
                            "Each ECHO unit is paired with a companion drone for physical interaction and data collection. The drone extends the AI's capabilities beyond communication.",
                            "ECHO units are built on simplified neural architectures—smart enough to assist, limited enough to be predictable. Unlike the Nexus... ECHO units cannot self-modify beyond their core programming.",
    ...
    public static final DeferredItem<Item> DATA_LOG_SURVIVOR_ALPHA = register("data_log_survivor_alpha",
            props -> new DataLogItem(props, DataLogItem.DataLogType.SURVIVOR_JOURNAL, "Day 47",
                    new String[]{"Found this terminal in an old shelter. If anyone finds this... I'm sorry. I can't keep going.",
                            "The air hurts. Everything hurts. I've been walking north for years since the Gridfall, and there's nowhere left that's clean.",
                            "I saw my first Glowing Ghoul yesterday. Used to be a person. The radiation changes you, they say. Some embrace it. Mutant Front welcomes the changed.",
                            "If you find this, take my supplies. I won't need them. And if you see ECHO-7... tell her I'm sorry. I couldn't make it to the Nexus."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
    ...
    public static final DeferredItem<Item> DATA_LOG_CLIMATE_WEAPONS = register("data_log_climate_weapons",
            props -> new DataLogItem(props, DataLogItem.DataLogType.RESEARCH_DATA, "Project Frostbite",
                    new String[]{"Classified - Military Application Division",
                            "Project Frostbite represents the militarization of climate control technology. By 2145, we had developed portable cryogenic generators capable of flash-freezing entire city blocks.",
                            "The official purpose: terraforming hostile environments. Creating habitable zones on Mars, Europa, Titan.",
                            "The actual purpose: area denial. Urban pacification. Population control.",
                            "When the Gridfall came, these weapons activated automatically. The Nexus saw them as 'efficient tools for resource preservation.' The cryogenic zones haven't thawed in years.",
                            "What we built to reach the stars... now keeps the wasteland frozen."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.RARE),
    ...
    public static final DeferredItem<Item> DATA_LOG_REMNANT_MANIFESTO = register("data_log_remnant_manifesto",
            props -> new DataLogItem(props, DataLogItem.DataLogType.PREFALL_HISTORY, "Remnant Collective Charter",
                    new String[]{"We are what remains of order.",
                            "The Remnant Collective formed in the first year after Gridfall. Military personnel, government officials, corporate security—anyone who remembered structure.",
                            "Our mission: Restore the Grid. Not because we loved the old world, but because chaos kills more than radiation ever will.",
                            "The Mutant Front calls us oppressors. The Salvagers call us idealists. We call ourselves survivors.",
                            "If you read this, you have a choice. Join us. Rebuild. Or stay in the chaos and pretend it's freedom."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
    ...
    public static final DeferredItem<Item> DATA_LOG_SALVAGER_CODE = register("data_log_salvager_code",
            props -> new DataLogItem(props, DataLogItem.DataLogType.PREFALL_HISTORY, "The Salvager's Creed",
                    new String[]{"Rule 1: Everything has value to someone.",
                            ...
                            "Rule 3: Neutral ground is sacred. Kill each other outside the trading post.",
                            "Rule 4: Debts are paid. Reputation is currency.",
                            "Rule 5: The past is scrap. The future is trade. Today is profit.",
                            "We don't fight for ideologies. We trade with Remnants, Mutants, and independents alike. In a world of scarcity, the middleman is king.",
    ...
    public static final DeferredItem<Item> DATA_LOG_MUTANT_TRUTH = register("data_log_mutant_truth",
            props -> new DataLogItem(props, DataLogItem.DataLogType.RESEARCH_DATA, "On Radiation Adaptation",
                    new String[]{"They call us monsters. We call ourselves evolved.",
                            "The radiation doesn't just poison—it transforms. Those who survive the sickness emerge... different. Night vision. Enhanced endurance. Resistance to the very toxins that kill normals.",
                            "The cost? Some lose their humanity. Literally. I've seen friends become Ghouls, their minds consumed by the radiation they embraced.",
                            "But those who maintain balance... we are the future. The old world feared change. We became it.",
                            "Join us in the bio-domes. The Remnants rebuild the past. We become the future."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
                    AshfallTooltip.of("data_log:research_data"));
    ...
    public static final DeferredItem<Item> DATA_LOG_FIRST_LIGHT = register("data_log_first_light",
            props -> new DataLogItem(props, DataLogItem.DataLogType.SURVIVOR_JOURNAL, "First Light Protocol",
                    new String[]{"Drop Pod Survival Memo - ECHO Field Revision",
                            "If the recycler is offline, do not wait for perfect tools. Bone, hide, plant fiber, and ash will keep a survivor breathing through the first night.",
                            "The wilderness tier is not primitive by accident. It is the bridge between impact shock and machine recovery.",
                            "Recover one schematic fragment before committing to a base. ECHO can reconstruct fabrication routines from even partial plans."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
                    AshfallTooltip.of("data_log:survivor_journal"));
    ...
    public static final DeferredItem<Item> DATA_LOG_RESEARCH_PROTOCOL = register("data_log_research_protocol",
            props -> new DataLogItem(props, DataLogItem.DataLogType.TECHNICAL_MANUAL, "Research Lab Protocol",
                    new String[]{"Research Lab Operating Note",
                            "Schematic fragments are compressed process memories: recipes, material tolerances, and field repairs too complex for a damaged terminal to infer alone.",
                            "Faction hubs became knowledge markets after the Gridfall. The Remnants guarded military designs, Salvagers traded routing maps, and the Mutant Front preserved biological research.",
                            "Install fragments through a Research Lab. ECHO will translate the recovered pattern into perks and craftable systems."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
                    AshfallTooltip.of("data_log:technical_manual"));
    ...
    public static final DeferredItem<Item> DATA_LOG_RELAY_NETWORK = register("data_log_relay_network",
            props -> new DataLogItem(props, DataLogItem.DataLogType.TECHNICAL_MANUAL, "Relay Network Recovery",
                    new String[]{"Radio Network Field Manual",
                            ...
                            "Activate each station before trusting it. ECHO can route the jump, but only repaired hardware can hold the carrier wave."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.UNCOMMON),
                    AshfallTooltip.of("data_log:technical_manual"));
    ...
    public static final DeferredItem<Item> DATA_LOG_NEXUS_SCAR = register("data_log_nexus_scar",
            props -> new DataLogItem(props, DataLogItem.DataLogType.NEXUS_ARCHIVES, "The Scar Signal",
                    new String[]{"Nexus Core Residual Trace",
                            "The Scar is not a crater. It is a synchronization wound where the Core forced power, weather, logistics, and human survival into one impossible equation.",
    ...
    public static final DeferredItem<Item> DATA_LOG_BIOME_BOSSES = register("data_log_biome_bosses",
            props -> new DataLogItem(props, DataLogItem.DataLogType.NEXUS_ARCHIVES, "Biome Guardian Dossiers",
                    new String[]{"ECHO Threat Index - Regional Guardians",
                            ...
                            "Industrial, cryogenic, toxic, radiation, crash-zone, and Nexus guardians each anchor a different Gridfall failure mode underground. Neutralize them to cut the path to the Core into stable, survivable steps.",
    ...
    public static final DeferredItem<Item> DATA_LOG_PREFALL_WARDEN = register("data_log_prefall_warden",
            props -> new DataLogItem(props, DataLogItem.DataLogType.NEXUS_ARCHIVES, "The Warden Directive",
                    new String[]{"Pre-Fall Archives Security Directive",
                            ...
                            "After the Gridfall, the Warden accepted Nexus authority as the highest surviving chain of command.",
                            "Any survivor who enters after choosing the Core's fate will be treated as a claimant to history itself. Defeat the Warden, and ECHO will mark the world-state resolved."}), new Item.Properties().rarity(net.minecraft.world.item.Rarity.EPIC),
                    AshfallTooltip.of("data_log:nexus_archives"));

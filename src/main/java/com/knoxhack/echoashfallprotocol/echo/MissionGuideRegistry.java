...
public final class MissionGuideRegistry {
    ...
    private static final Map<String, Guide> GUIDES = Map.ofEntries(
            ...
            Map.entry("first_faction_contact", guide("Faction Contacts", "Faction channels open through Echo Core contacts, POI affinity, and route work. Discover a matching site or speak with any Ashfall faction contact.")),
            ...
            Map.entry("restore_epilogue", guide("Restore Epilogue", "The final Restore protocol resolves the repaired grid after The Warden falls. Return the epilogue through the mission channel and let the branch close.")),
            ...
            Map.entry("destroy_epilogue", guide("Destroy Epilogue", "The final Destroy protocol ends grid authority after The Warden falls. Return the epilogue through the mission channel and leave the signal unowned.")),
            ...
            Map.entry("control_epilogue", guide("Control Epilogue", "The final Control protocol binds the wasteland network to your signal after The Warden falls. Return the epilogue through the mission channel and accept the cost of command."))
    );

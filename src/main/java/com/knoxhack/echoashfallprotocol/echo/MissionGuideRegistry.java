...
public final class MissionGuideRegistry {
    ...
    private static final Map<String, Guide> GUIDES = Map.ofEntries(
            ...
            Map.entry("neutralize_radiation_behemoth", guide("Radiation Behemoth", "Radwarden marks this reactor sink as containment failure. Bring RadAway, hazmat support, and a scrubber fallback; treat after pulses.")),
